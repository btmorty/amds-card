import { IPatient, PatientName, PatientNameTypes } from '@advancedmd/patient-card';
import { Component } from '@angular/core';
import { CompactType, GridsterConfig, GridsterItem, GridType } from 'angular-gridster2';

@Component({
  selector: 'amds-patient-info',
...
export class AppComponent {
  ...
  mockPatient: IPatient = {
    ...
    chartnumber: '1111',
    names: [
      new PatientName('Paula', '', 'Smith', true, false, false, 1, PatientNameTypes.Legal),
      new PatientName('Pat', '', 'Smith', false, true, false, 2, PatientNameTypes.Alternate),
      new PatientName('Paula', '', 'Wilson', false, false, true, 3, PatientNameTypes.Maiden)
    ],
    ssn: '111-11-1111',
